...
export class Level1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.scaling_factor = (this.screen_width/16)/900/this.shrink_factor;
        this.x_offset = 37/this.shrink_factor;
        this.y_offset = 37/this.shrink_factor;
        ...
        this.board = new Board(this,1280,this.scaling_factor,this.x_offset,this.y_offset,this.pixel_grid,this.valve);
        this.deadlock = false;
        this.timeSinceValve = null;
