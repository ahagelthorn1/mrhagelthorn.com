...
export class Start extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.topChoice == null) {
            this.topChoice = this.getRandom(this.options);
        } else {
            if (typeof this.topChoice == "string") {
                this.topChoice = unpack(this.topChoice,this);
            }
            let flag = topRow(this.topChoice);
            if (flag == 0) {
                this.topChoice = null;
            }
        }
        if (this.midChoice == null) {
            ...
            let flag = midRow(this.midChoice);
            if (flag == 0) {
                this.midChoice = null;
            }
        }
        if (this.bottomChoice == null) {
            ...
            let flag = bottomRow(this.bottomChoice);
            if (flag == 0) {
                this.bottomChoice = null;
            }
        }
