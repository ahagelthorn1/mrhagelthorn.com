...
export class Menu extends Phaser.Scene {
    ...
    update(time,delay) {
        this.movementSpeed = delay/10 + 10;
        ...
        function topRight(choice,speed) {
            for (let i = 0; i < choice.length; i++) {
                if (choice[i].y < 200) {
                    choice[i].y += speed;
                }
        ...
        function bottomLeft(choice,speed) {
            for (let i = 0; i < choice.length; i++) {
                if (choice[i].y < 600) {
                    choice[i].y += speed;
                }
        ...
        function bottomRight(choice,speed) {
            for (let i = 0; i < choice.length; i++) {
                if (choice[i].y < 600) {
                    choice[i].y += speed;
                }
        ...
        if (this.topLeftChoice == null) {
            ...
            let flag = topLeft(this.topLeftChoice,this.movementSpeed);
            if (flag == 0) {
                this.topLeftChoice = null;
            }
        }
        if (this.bottomLeftChoice == null) {
            ...
            let flag = bottomLeft(this.bottomLeftChoice,this.movementSpeed);
            if (flag == 0) {
                this.bottomLeftChoice = null;
            }
        }
        if (this.bottomRightChoice == null) {
            ...
            let flag = bottomRight(this.bottomRightChoice,this.movementSpeed+5);
            if (flag == 0) {
                this.bottomRightChoice = null;
            }
        }
        if (this.topRightChoice == null) {
            ...
            let flag = topRight(this.topRightChoice,this.movementSpeed+5);
            if (flag == 0) {
                this.topRightChoice == null;
            }
        }
        if (this.select_level.y < 160) {
            this.select_level.y += this.movementSpeed;
        }
        if (this.box.y > 464) {
                this.box.y -= this.movementSpeed;
        }
        for (let i = 0; i < this.bottomButtons.length; i++) {
            if (this.topButtons[i].y > 330) {
                this.topButtons[i].y -= this.movementSpeed;
            }
            if (this.bottomButtons[i].y > 530) {
                this.bottomButtons[i].y -= this.movementSpeed;
            }
        }
