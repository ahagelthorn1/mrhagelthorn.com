export class Level1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('Annex', 'assets/annex.png');
    ...
    create() {
        ...
        this.Level1Map = this.add.image(370,260,'Level1Map');
        this.Level1Map.setScale(.85);
        this.mapTexture = this.textures.get('Level1Map').getSourceImage();
        let key = 'mapCanvas';
        ...
        for(let i = 0; i < 89; i++) {
            if (i != 50 && i != 60 && i != 65 && i != 70 && i != 85 && i != 86 && i != 87 && i != 88) {
                this.Malware = this.add.sprite(680,y_offset,this.MALWARE_TEXTURE);
                ...
                this.Phish = this.add.sprite(680, y_offset, this.PHISH_TEXTURE);
                ...
                this.DDOS = this.add.sprite(680, y_offset, this.DDOS_TEXTURE);
                ...
                this.Ransomware = this.add.sprite(680, y_offset, this.RANSOMWARE_TEXTURE);
                ...
                this.Trojan = this.add.sprite(680, y_offset, this.TROJAN_TEXTURE);
    ...
    isGreenPixel(worldX, worldY) {
        const localX = Math.floor((worldX - this.Level1Map.x + (this.Level1Map.displayWidth / 2)) / this.Level1Map.scaleX);
        const localY = Math.floor((worldY - this.Level1Map.y + (this.Level1Map.displayHeight / 2)) / this.Level1Map.scaleY);
